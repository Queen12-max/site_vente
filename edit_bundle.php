...
<i class="fa fa-dashboard"> </i> Dashboard / Modifier Paquet
...
<i class="fa fa-money fa-fw"></i> Modifier Paquet
...
<label class="col-md-3 control-label" > Selectionner un fabricant </label>
...
<label class="col-md-3 control-label" > Categorie Produit  </label>
...
<label class="col-md-3 control-label" > Paquet mots clés </label>
...
<label class="col-md-3 control-label" > Tabs Paquets </label>
...
<label class="col-md-3 control-label" > Paquet Etiquette </label>
