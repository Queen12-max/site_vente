...
<i class="fa fa-dashboard" ></i> Dashboard / Modifier Contact
...
<i class="fa fa-money fa-fw"></i> Modifier Contact
...
<label class="col-md-3 control-label"> Rubrique Contact: </label>
...
<label class="col-md-3 control-label"> Description Contact: </label>
