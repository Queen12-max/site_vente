...
<i class="fa fa-dashboard"></i> Dashboard / Modifier Fabricant
...
<i class="fa fa-money fa-fw"> </i> Modifier Fabricant
...
<label class="col-md-3 control-label"> Nom Fabricant </label>
...
<label class="col-md-3 control-label"> Afficher en tant que meilleur Fabricant </label>
...
<label class="col-md-3 control-label"> Sélectionnez une image de Fabricant </label>
