...
<i class="fa fa-dashboard"> </i> Dashboard / Modifier Produits
...
<i class="fa fa-money fa-fw"></i> Modifier Produits
...
<label class="col-md-3 control-label" > Prix Produit </label>
...
<label class="col-md-3 control-label" > Onglet Produit </label>
...
<label class="col-md-3 control-label" > Etiquette Product </label>
