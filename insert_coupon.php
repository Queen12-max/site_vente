...
<i class="fa fa-dashboard"> </i> Dashboard / Insérer Coupon
...
<i class="fa fa-money fa-fw"> </i> Insérer Coupon
...
<label class="col-md-3 control-label"> Titre Coupon </label>
...
<label class="col-md-3 control-label"> Prix Coupon </label>
...
<label class="col-md-3 control-label"> Code Coupon </label>
...
<label class="col-md-3 control-label"> Limit Coupon </label>
...
<label class="col-md-3 control-label">Sélectionnez un coupon pour Produit et Paquet</label>

<div class="col-md-6">

<select name="product_id" class="form-control">

<option> Sélectionnez un Coupon Produit  </option>
...
<option>Sélectionnez un Coupon pour Paquet</option>
