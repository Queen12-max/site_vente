...
<i class="fa fa-dashboard"></i> Dashboard / Modifier Catégorie Produit
...
<i class="fa fa-money fa-fw" ></i> Modifier Catégorie Produit
...
<label class="col-md-3 control-label" >Titre Catégorie Produit</label>
...
<label class="col-md-3 control-label" >Afficher comme première Catégorie de Produit</label>
...
<label class="col-md-3 control-label" > Sélectionnez une image de Catégorie de Produit</label>
