  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Panier</span> d'Achat
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Vous avez actuellement <?php echo $count; ?> un article ans votre panier. </p>
...
<i class="fa fa-refresh"></i> Mis à jour panier

</button>

<a href="checkout.php" class="btn btn-success">

Passer à la caisse <i class="fa fa-chevron-right"></i>
...
<h3 class="text-center"> Vous aimez aussi ces prouits </h3>
...
<p class="text-muted">
Les frais d'expéition et supplémentaires sont calculés en fonction es valeurs que vous avez saisies.
</p>
...
<td> Frais port et manutention </td>
