...
<i class="fa fa-dashboard"></i> Dashboard / Insérer Relation
...
<i  class="fa fa-money fa-fw"></i> Insérer Relation
...
<label class="col-md-3 control-label"> Titre Relation  </label>
...
<label class="col-md-3 control-label"> Sélectionnez Produit  </label>

<div class="col-md-6">

<select name="product_id" class="form-control">

<option> Sélectionnez Produit </option>
...
<label class="col-md-3 control-label"> Sélectionnez Paquet  </label>

<div class="col-md-6">

<select name="bundle_id" class="form-control">

<option> Sélectionnez Paquet </option>
