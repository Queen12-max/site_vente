...
<i class="fa fa-dashboard" ></i> Dashboard / Modifier Page A propos
...
<i class="fa fa-money fa-fw"></i> Modifier Page A propos
...
<label class="col-md-3 control-label"> Titre A propos : </label>
...
<label class="col-md-3 control-label"> Court Description A propos : </label>
...
<label class="col-md-3 control-label"> Description A propos : </label>
