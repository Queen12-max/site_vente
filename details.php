  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Voir </span>Produit
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label class="col-md-5 control-label" >Quantité Produit </label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_qty" class="form-control" >

<option>Sélectionner quantité</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<label class="col-md-5 control-label" >Taille Product</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_size" class="form-control" >

<option>Select taille</option>
<option>Petit</option>
<option>Moyen</option>
<option>Grand</option>
...
<label class="col-md-5 control-label" >Quantité Paquet </label>
...
<label class="col-md-5 control-label" >Taille Paquet</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_size" class="form-control" >

<option>Sélectionner taille</option>
<option>Petit</option>
<option>Moyen</option>
<option>Grand</option>
...
<i class="fa fa-heart" ></i> Ajouter à la lsite souhaits
...
<h3 class="text-center"> Vous aimerez peut-être aussi ces produits : nous vous proposons les 3 meilleurs produits. </h3>
...
<h3 class="text-center"> Produits groupés </h3>
