...
<i class="fa fa-dashboard"> </i> Dashboard / Insérer Produits
...
<label class="col-md-3 control-label" > Url Produit </label>
...
Url Produit Exemple : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Produit Price </label>
...
<label class="col-md-3 control-label" > Prix de Vente Produit </label>
...
<label class="col-md-3 control-label" > Mots-clés Produit </label>
...
<label class="col-md-3 control-label" > Onglets Produit </label>
...
<a data-toggle="tab" href="#description"> Description Produit </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Caractéristiques Produit </a>
...
<label class="col-md-3 control-label" > Etiquette Produit </label>
