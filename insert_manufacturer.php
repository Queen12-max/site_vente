...
<i class="fa fa-dashboard"></i> Dashboard / Insérer Fabricant
...
<i class="fa fa-money fa-fw"> </i> Insérer Fabricant
...
<label class="col-md-3 control-label"> Séléctionnez une Image de Fabricant </label>
