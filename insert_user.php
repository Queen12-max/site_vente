...
<i class="fa fa-dashboard" ></i> Dashboard / Inseérer Utilisateur
...
<i class="fa fa-money fa-fw" ></i> Inseérer Utilisateur
...
<label class="col-md-3 control-label">Nom Utilisateur: </label>
...
<label class="col-md-3 control-label">Email Utilisateur: </label>
...
<label class="col-md-3 control-label">Mots de passe Utilisateur: </label>
...
<label class="col-md-3 control-label">Pays Utilisateur: </label>
...
<label class="col-md-3 control-label">Emploi Utilisateur: </label>
...
<label class="col-md-3 control-label">Contact Utilisateur: </label>
...
<label class="col-md-3 control-label">A propos Utilisateur: </label>
...
<label class="col-md-3 control-label">Image Utilisateur: </label>
