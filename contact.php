  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Contacter</span> nous
      </div>
      <p class="nero__text">
      Si vous avez es questions, n'hésiter pas à nous contacter, notre centre de service client travaille pour vous 24h/24 et 7j/7.
      </p>
    </div>
  </main>
...
<label> Sélectionnez le type de demande </label>


<select name="enquiry_type" class="form-control"><!-- select Starts -->

<option> Sélectionnez le type de demande </option>
