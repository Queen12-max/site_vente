...
<i class="fa fa-dashboard"></i> Dashboard / Insérer Termes
...
<i class="fa fa-money fa-fw"></i> Insérer Termes
...
<label class="col-md-3 control-label"> Titre Terme </label>
...
<label class="col-md-3 control-label"> Description Terme </label>
