...
<i class="fa fa-dashboard"> </i> Dashboard / Insérer Paquet
...
<i class="fa fa-money fa-fw"></i> Insérer Paquet
...
<label class="col-md-3 control-label" > Titre Paquet </label>
...
<label class="col-md-3 control-label" > Url Paquet </label>
...
Url Paquet Exemple : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Sélectionnez un Fabricant </label>

<div class="col-md-6" >

<select class="form-control" name="manufacturer"><!-- select manufacturer Starts -->

<option> Sélectionnez un Fabricant </option>
...
<label class="col-md-3 control-label" > Catégorie Produit </label>

<div class="col-md-6" >

<select name="product_cat" class="form-control" >

<option> Sélectionnez un Catégorie Produit </option>
...
<label class="col-md-3 control-label" > Paquet Image 1 </label>
...
<label class="col-md-3 control-label" > Paquet Image 2 </label>
...
<label class="col-md-3 control-label" > Paquet Image 3 </label>
...
<label class="col-md-3 control-label" > Prix Paquet </label>
...
<label class="col-md-3 control-label" > Prix de Vente Paquet </label>
...
<label class="col-md-3 control-label" > Mots-clés Paquet </label>
...
<label class="col-md-3 control-label" > Onglets Paquet </label>
...
<a data-toggle="tab" href="#description"> Description Paquet </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Caractéristiques Paquet </a>

</li>

<li>

<a data-toggle="tab" href="#video"> Sons et Vidéos </a>
...
<label class="col-md-3 control-label" > Etiquette Paquet </label>
