...
<i class="fa fa-dashboard"></i> Dashboard / Insérer Catégorie
...
<i class="fa fa-money fa-fw"></i> Insérer Catégorie
...
<label class="col-md-3 control-label">Titre Categorie</label>
...
<label class="col-md-3 control-label">Sélectionnez une Image de Catégorie</label>
