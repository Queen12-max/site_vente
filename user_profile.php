...
<i class="fa fa-dashboard" ></i> Dashboard / Modifier Profile
...
<i class="fa fa-money fa-fw" ></i> Modifier Profile
...
<label class="col-md-3 control-label">Mot de passe Utilisateur: </label>
