...
<i class="fa fa-dashboard"></i> Dashboard / Modifier Termes
...
<i class="fa fa-money fa-fw"></i> Modifier Termes
...
<label class="col-md-3 control-label"> Titre Termes </label>
...
<label class="col-md-3 control-label"> Descriptionn Terme </label>
...
<label class="col-md-3 control-label"> Lien Terme </label>
