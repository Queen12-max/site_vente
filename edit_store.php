...
<i class="fa fa-dashboard" ></i> Dashboard / Modifier Boutique
...
<i class="fa fa-money fa-fw"></i> Modifier Boutique
...
<label class="col-md-3 control-label"> Titre Boutique : </label>
...
<label class="col-md-3 control-label"> Image Boutique : </label>
...
<label class="col-md-3 control-label"> Description Boutique : </label>
...
<label class="col-md-3 control-label"> Bouton Boutique : </label>
...
<label class="col-md-3 control-label"> Url Boutique : </label>
