...
<i class="fa fa-dashboard"></i> Dashboard / Modifier catégories
...
<i class="fa fa-money fa-fw"></i> Modifier catégories
...
<label class="col-md-3 control-label">Titre catégorie</label>
...
<label class="col-md-3 control-label">Afficher en haut de la catégorie</label>
...
<label class="col-md-3 control-label">Sélectionnez une image de catégories</label>
